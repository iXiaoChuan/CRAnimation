...
@implementation CircleKnobDemoVC

- (void)viewDidLoad {
    [super viewDidLoad];
    
    [self createUI];
    [self addTopBarWithTitle:@"CircleKnobDemoVC"];
}
...
- (void)panSunEvent:(UIPanGestureRecognizer *)panGesture
{
    ...
    [sunImgView setCenterX:sunImgView.center.x + point.x - CGRectGetWidth(sunImgView.frame)/2];
    [sunImgView setCenterY:sunImgView.center.y + point.y - CGRectGetHeight(sunImgView.frame)/2];
